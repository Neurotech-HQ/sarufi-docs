...
```bash
curl -X GET https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows \
...
response = requests.get(
    "https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows",
...
```bash
curl -X POST https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows \
  -H "Authorization: Bearer <your-api-key>" \
...
```bash
curl -X GET https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id> \
  -H "Authorization: Bearer <your-api-key>"
```
...
import requests
response = requests.get(
    "https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id>",
    headers={"Authorization": "Bearer <your-api-key>"},
)
print(response.json())
```
...
```bash
curl -X PATCH https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id> \
  -H "Authorization: Bearer <your-api-key>" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id>/validate \
  -H "Authorization: Bearer <your-api-key>"
```
...
import requests
response = requests.post(
    "https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id>/validate",
    headers={"Authorization": "Bearer <your-api-key>"},
)
print(response.json())
```
...
```bash
curl -X POST https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id>/publish \
  -H "Authorization: Bearer <your-api-key>"
```
...
import requests
response = requests.post(
    "https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id>/publish",
    headers={"Authorization": "Bearer <your-api-key>"},
)
print(response.json())
```
...
```bash
curl -X DELETE https://developers.sarufi.io/api/dev/v1/chatbots/<chatbot-id>/flows/<flow-id> \
  -H "Authorization: Bearer <your-api-key>"
```
